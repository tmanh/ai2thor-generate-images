...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	abstract public class BaseFPSAgentController : MonoBehaviour
	{
		...
		public virtual MetadataWrapper generateMetadataWrapper()
		{
            ...
            agentMeta.r1 = new Vector4(m_Camera.worldToCameraMatrix[0, 0], m_Camera.worldToCameraMatrix[0, 1], m_Camera.worldToCameraMatrix[0, 2], m_Camera.worldToCameraMatrix[0, 3]);
            agentMeta.r2 = new Vector4(m_Camera.worldToCameraMatrix[1, 0], m_Camera.worldToCameraMatrix[1, 1], m_Camera.worldToCameraMatrix[1, 2], m_Camera.worldToCameraMatrix[1, 3]);
            agentMeta.r3 = new Vector4(m_Camera.worldToCameraMatrix[2, 0], m_Camera.worldToCameraMatrix[2, 1], m_Camera.worldToCameraMatrix[2, 2], m_Camera.worldToCameraMatrix[2, 3]);
            agentMeta.t = new Vector4(m_Camera.worldToCameraMatrix[3, 0], m_Camera.worldToCameraMatrix[3, 1], m_Camera.worldToCameraMatrix[3, 2], m_Camera.worldToCameraMatrix[3, 3]);
